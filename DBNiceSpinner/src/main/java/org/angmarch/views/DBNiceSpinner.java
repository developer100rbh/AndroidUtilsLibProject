...
// */
//public class DBNiceSpinner extends AppCompatTextView {
//
...
//
//    public DBNiceSpinner(Context context) {
//        super(context);
//        init(context, null);
//    }
//
//    public DBNiceSpinner(Context context, AttributeSet attrs) {
//        super(context, attrs);
//        init(context, attrs);
//    }
//
//    public DBNiceSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
