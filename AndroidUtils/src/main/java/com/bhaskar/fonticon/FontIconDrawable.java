...
public class FontIconDrawable extends Drawable {
    ...
    public void inflate(Context context, AttributeSet attrs) throws XmlPullParserException, IOException {
        ...
        try {
            mText = a.getString(R.styleable.FontIconDrawable_fid_text);
            if (mText == null) {
                mText = "";
            }

            mTextColor = a.getColorStateList(R.styleable.FontIconDrawable_fid_textColor);
            if (mTextColor == null) {
                mTextColor = ColorStateList.valueOf(0);
            }

            mTextSize = a.getDimension(R.styleable.FontIconDrawable_fid_textSize, 9f);
